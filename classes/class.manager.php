...
class manager extends user{
    ...
    function __construct($data){
        $this->assign($data);
        $this->group_id = user_group::getIdFromGroupName('manager');
	}
    ...
    static function vSave($data){
        ...
        $data->group_id = user_group::getIdFromGroupName('manager');
    ...
    static function saveExtended($userId, $data){
        ...
        $data = json_encode(array_diff_key($data, $disallowExtendedAttributes));
        
        global $config;
        $db = new db;
        $query = $db->build_insert($config['coreTablePrefix'].'users_extended', ['user_id' => $userId, 'data' => $data]);
