...
">
    <div style="padding-bottom: 10px;">
        Attraction <a href="{$template_vars->attractionUrl}"><strong>{$template_vars->diffs->name|default:{$template_vars->attraction->name|default:'unknown'}}</strong></a> has received the following update(s)
    </div>
    <br/>
