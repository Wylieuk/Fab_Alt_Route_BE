   	 	...
   	 	foreach ($namespaces as $prefix => $namespace) {
				...
				next ($childArray);
   	        	...
   	        	//add namespace prefix, if any
   	         	if ($prefix && !$options['removeNameSpaces'] ) $childTagName = $prefix . $options['namespaceSeparator'] . $childTagName;
				...
				else {//key exists so convert to integer indexed array with previous value in position 0
